...
## 一些知乎上的觉得讲解得比较准确的文章
### [1](https://zhuanlan.zhihu.com/p/28539046)
### [2](https://zhuanlan.zhihu.com/p/29675083)

同步/异步指的是真正io操作（数据从内核态用户态的拷贝）是否需要进程参与，就java nio读操作来说，如果接收到可读事件通知，具体的读操作还是需要应用进程参与的，见文章1的图
